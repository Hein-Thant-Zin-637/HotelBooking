...
<main class="w-100 w-md-50 my-5">
    ...
    <form class="container fs-4" action="/register" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control shadow-none fs-5" id="conpassword" name="conpassword" placeholder="Confirm Password">
            <?php if (isset($errors['conpassword'])) : ?>
                <p class="text-danger fs-5"><?= $errors['conpassword'] ?></p>
            <?php endif ?>
        </div>
