...
<main class="content-wrapper p-3" style="margin-top:50px ;">
    <form action="/addrooms" class="mx-5 fs-4 " method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="number" class="form-control shadow-none fs-5" id="adults" name="adults" value="<?= $_POST['adults'] ?? '' ?>">
        </div>
        <div class="mb-3 mt-3">
            <label for="childs" class="form-label">Max Childs :</label>
            <input type="number" class="form-control shadow-none fs-5" id="childs" name="childs" value="<?= $_POST['childs'] ?? '' ?>">
        </div>
        <div class="mb-3 mt-3">
            <label for="bed" class="form-label">Number of Bed :</label>
            <input type="number" class="form-control shadow-none fs-5" id="bed" name="bed" value="<?= $_POST['bed'] ?? '' ?>">
        </div>
        <div class="mb-3 mt-3">
            <label for="price" class="form-label">Price :</label>
            <input type="number" class="form-control shadow-none fs-5" id="price" name="price" value="<?= $_POST['price'] ?? '' ?>">
        </div>
        ...
        <?php endif ?>
        <button type="submit" class="btn btn-success btn-lg mt-3">Add Room</button>
    </form>
</main>
