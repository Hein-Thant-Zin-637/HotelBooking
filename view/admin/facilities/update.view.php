...
<main class="content-wrapper p-3" style="margin-top:50px ;">
    <form action="/updatefacilities" class="mx-5 fs-4 " method="POST" enctype="multipart/form-data">
        <div class="mb-3 d-flex flex-column">
            <label for="imgInp" class="form-label">Image :</label>
            <img id="blah" src="<?= $facilitie['image'] ?>" alt="your image" class="my-3 img-fluid img-thumbnail " style="max-width:80% !important; max-height:400px !important; " />
        ...
        <textarea class="form-control shadow-none fs-5" rows="5" id="description" placeholder="Enter Your Description"
            name="description"><?= $facilitie['description'] ?? '' ?></textarea>
